...
public class Order implements Comparable<Order> {
  ...
  /**
   * Compares two Order type objects.
   *
   * @param o The order being compared to.
   * @return 0 if the orders prepTime values are equal, and -1 if an Order is "less than" another Order if its
   * prepTime is shorter than the other Order's, otherwise 1.
   */
  @Override
